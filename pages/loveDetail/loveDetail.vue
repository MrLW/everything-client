<template>
	<view class="container">
		...
		<scroll-view class="main" scroll-y>
			<view class="cardList">
				<view class="cardItem" v-for="item in momentList" @click="getMomentDetailPage">
					<uni-card is-shadow>
						...
						<template v-slot:actions>
							<view class="card-actions">
								...
								<view class="card-actions-item" @click="love(item.id)">
									<!-- TODO 待处理 -->
									<uni-icons :type="item.loves >= 10 ? 'heart-filled': 'heart' " size="18" :color="item.loves >= 10 ? 'red': 'darkgray'"></uni-icons>
...
import { getMomentDetailPage,goCreateMomentPage, momentList, getNewMomentList, love } from './index.js'
const days = ref(100)
