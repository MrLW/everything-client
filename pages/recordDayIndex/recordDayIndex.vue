			...
			<view class="popup-content">
				<uni-forms ref="form" :rules="rules" :modelValue="eventItem">
					...
					<uni-forms-item label="老公" class="formItem" v-if="eventItem.type == 'marry'" name="husband" required>
						<uni-easyinput placeholder="最多4个字" v-model="eventItem.husband" maxlength="4" :clearable="false" />
					</uni-forms-item>
					...
					<uni-forms-item label="姓名" class="formItem" name="username"
						required>
						<uni-easyinput placeholder="最多4个字" v-model="eventItem.username" maxlength="4" :clearable="false" />
					</uni-forms-item>
					...
					<uni-forms-item label="备注" class="formItem" name="remark">
						<uni-easyinput placeholder="最多10个字" v-model="eventItem.remark" maxlength="10" :clearable="false" />
					</uni-forms-item>
					<view class="btn">
...
import { getRecordDayCategoryList } from '../../api/recordDayCategory';
import {
	classNameMap,
	diffDays,
	eventTypeMap
